...
class StudentMarkManager:
    ...
    def input_courses(self):
        ...
        with open('course.pickle', 'wb') as file:
    ...
    def input_marks(self):
        ...
        with open('mark.pickle', 'wb') as file:
    ...
    def zipin():
        with zipfile.ZipFile('pickledStudent.dat', 'w', compression=zipfile.ZIP_DEFLATED) as my_zip:
            my_zip.write('course.pickle')
            my_zip.write('student.pickle')
            my_zip.write('marks.pickle')